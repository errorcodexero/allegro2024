...
public class SwerveTestAutoMode extends TestAutoMode {
    ...
    public SwerveTestAutoMode(AutoController ctrl, String name) throws BadParameterTypeException, MissingParameterException {
        super(ctrl, name) ;
    }
    ...
    protected boolean createTest() throws Exception {
        ...
        if (!(db instanceof SwerveBaseSubsystem)) {
            throw new Exception("SwerveTestAutoMode is used as the base class of the test automode but the drive base is not swerve") ;
        }
        ...
        switch (getTestNumber()) {
            ...
            case 3:
                ...
                addSubActionPair(swerve, new SwerveSpeedAngleAction(swerve, angles, powers, getDouble("duration")), true);                
                break ;                
