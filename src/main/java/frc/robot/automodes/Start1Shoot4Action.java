...
public class Start1Shoot4Action extends Action {
    private static final double kRotatePosTol = 2.0 ;
    private static final double kCollectEndOfPathDistance = 1.0 ;
    ...
    public Start1Shoot4Action(AllegroRobot2024 robot, boolean mirror, double mvalue) throws Exception {
        ...
        p1_.addDistanceBasedAction(p1_.getPathLength() - kCollectEndOfPathDistance, () -> { robot.getIntakeShooter().setAction(start_collect_); });

        p2_ = new SwerveHolonomicPathFollower(robot.getSwerve(), "S1S4-P2", false, 0.2, mirror_, mvalue_);
        p2_.addDistanceBasedAction(p2_.getPathLength() - kCollectEndOfPathDistance, () -> { robot.getIntakeShooter().setAction(start_collect_); });
        ...
        p4_.addDistanceBasedAction(p4_.getPathLength() - kCollectEndOfPathDistance, () -> { robot.getIntakeShooter().setAction(start_collect_); });        
