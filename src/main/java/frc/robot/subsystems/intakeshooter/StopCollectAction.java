...
public class StopCollectAction extends Action {
    ...
    public StopCollectAction(IntakeShooterSubsystem sub) throws Exception {
        ...
        intake_up_ = new MCMotionMagicAction(sub_.updown(), "pids:position", "targets:stow", 1, 1) ;
        spinner_feeder_off_ = new MotorEncoderPowerAction(sub_.spinner_feeder(), 0.0) ;
        tilt_stow_ = new MCMotionMagicAction(sub_.tilt(), "pids:position", "targets:stow", 1, 1);
    }
    ...
    public void start() throws Exception {
        ...
        sub_.spinner_feeder().setAction(spinner_feeder_off_, true) ;
        sub_.tilt().setAction(tilt_stow_, true) ;
    }
    ...
    public void run() throws Exception {
        ...
        if (sub_.tilt().getPosition() < tilt_threshold_) {
            sub_.updown().setAction(intake_up_, true) ;
        }
